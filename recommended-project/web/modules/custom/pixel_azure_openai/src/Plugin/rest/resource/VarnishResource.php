 ...
 *
 * @RestResource (
 *   id = "pixel_azure_varnish",
 *   label = @Translation("AzureOpenAI"),
 *   uri_paths = {
 *     "canonical" = "/api/pixel-azure/varnish",
 *     "create" = "/api/pixel-azure/varnish"
 *   }
 * )
 *
 * @see \Drupal\rest\Plugin\rest\resource\EntityResource
 */
class VarnishResource extends ResourceBase
{
	/**
