 ...
 *
 * @RestResource (
 *   id = "pixel_azure_format",
 *   label = @Translation("AzureOpenAI"),
 *   uri_paths = {
 *     "canonical" = "/api/pixel-azure/format",
 *     "create" = "/api/pixel-azure/format"
 *   }
 * )
 *
 * @see \Drupal\rest\Plugin\rest\resource\EntityResource
 */
class FormatResource extends ResourceBase
{
	/**
	...
	public function post(Request $request)
	{
		...
		$answer = $azure_api->format($texts, $step);
